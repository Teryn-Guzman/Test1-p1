...
('0198f000-0000-7000-8000-000000000204','1198f000-0000-4000-8000-000000000002','0198f000-0000-7000-8000-000000000002','data_export','processing','{"format":"csv"}',NULL,NULL,now()-interval '1 minute',NULL,now()-interval '2 minutes')
ON CONFLICT (id) DO NOTHING;
